...
/**
 * Represents a decks model - a central interface to interact with cards.
 * Via {@link DecksModel} it is possible to manage cards in any possible way: create, delete, etc.
 */
